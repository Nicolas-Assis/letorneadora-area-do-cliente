...
import {
  ...
  ProfileSummaryDto,
  ProductSummaryDto,
} from '../api/dto/order/order.dto';
import { CreateOrderDto, CreateOrderItemDto } from '../api/dto/order/create-order.dto';
...
//    order.profileId = String(dto.profileId);
    order.status = OrderStatus.PENDING;
//    order.notes = dto.notes;
//    order.quoteId = Number(dto.quoteId);
...
//    dto.id = order.id;
//    dto.userId = order.user ? order.user.id : undefined;
