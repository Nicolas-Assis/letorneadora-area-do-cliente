...
// //import { Ticket, TicketStatus } from '../api/entities/ticket.entity';
// import { TicketMessage } from '../api/entities/ticket-message.entity';
// import { Users } from '../api/entities/user.entity';
// import { CreateTicketDto } from '../api/dto/ticktet/create-ticket.dto';
// import { UpdateTicketDto } from '../api/dto/ticktet/update-ticket.dto';
// import { AddMessageDto } from '../api/dto/ticktet/add-message.dto';
// import { FilterTicketsDto } from '../api/dto/ticktet/filter-tickets.dto';
// import { TicketDto, TicketMessageDto } from '../api/dto/ticktet/ticket.dto';
...
//   async findAll(filter: FilterTicketsDto): Promise<PaginationQueryDto> {
//     const {
//       // page = 1,
//       // limit = 10,
//       profileId,
...
//     // const ticketDtos = this.ticketFactory.toDTOList(
//     //   tickets,
//     //   includeProfile || includeAssignee || includeMessages,
//     // );
