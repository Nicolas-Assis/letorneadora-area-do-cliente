...
// import { FilterAuditLogsDto } from '../dto/audit-log/filter-audit-logs.dto';
// import { AuditLogDto } from '../dto/audit-log/audit-log.dto';
...
//     description: 'Acesso negado - role insuficiente',
//   })
//   async findAll(@Query() filter: FilterAuditLogsDto): Promise<PaginationQueryDto> {
