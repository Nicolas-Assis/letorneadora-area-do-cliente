...
export class AuditLogsService {
  ...
  async logCreate(entityType: string, entityId: string, description: string, newValues: any, userId?: string, ipAddress?: string, userAgent?: string): Promise<void> {
    await this.create({
      userId,
  ...
  async logUpdate(entityType: string, entityId: string, description: string, oldValues: any, newValues: any, userId?: string, ipAddress?: string, userAgent?: string): Promise<void> {
    await this.create({
      userId,
  ...
  async logDelete(entityType: string, entityId: string, description: string, oldValues: any, userId?: string, ipAddress?: string, userAgent?: string): Promise<void> {
    await this.create({
      userId,
  ...
  async logLogin(userId: string, description: string, ipAddress?: string, userAgent?: string): Promise<void> {
    await this.create({
      userId,
  ...
  async logLogout(userId: string, description: string, ipAddress?: string, userAgent?: string): Promise<void> {
    await this.create({
      userId,
